...
const Features = () => {
    return (
        <section className="bg-color-white
         ...
         ">
            <div class="lg:items-center lg:w-full  lg:mb-32">
                <h1 class="text-6xl text-center text-color-blue items-center "><b>Features</b></h1>
                <p class="text-color-grey my-4 text-center items-center lg:w-full m-4">
            ...
            <div class="relative mt-20 lg:mt-24">
                <div class="container flex flex-col lg:flex-row items-center justify-center gap-x-24">
                    ...
                    <div class="flex flex-1 justify-center z-10 mb-10 lg:mb-0">
                        <img
                            class="w-5/6 h-5/6 sm:w-3/4 sm:h-3/4 md:w-full md:h-full lg:ml-96 "
                            src={code}
                            alt=""
                        />
                    </div>

                    <div class="flex flex-1 flex-col items-center lg:items-start lg:ml-72">
                        <h1 class="text-3xl text-color-blue"><b>Codes in one click</b></h1>
                        <p class="text-color-grey my-4 text-center lg:text-left sm:w-3/4 lg:w-full w-80">
          ...
          "
            ...
            <div class="relative mt-20 lg:mt-52">
                <div class="container flex flex-col lg:flex-row-reverse items-center justify-center gap-x-24 ">
                    ...
                    <div class="flex flex-1 flex-col items-center lg:items-start lg:ml-60">
            ...
            <div class="relative mt-20 lg:mt-52">
                <div class="container flex flex-col lg:flex-row items-center justify-center gap-x-24">
                    ...
                    <div class="flex flex-1 flex-col items-center lg:items-start lg:ml-72">
                        ...
                        <p class="text-color-grey my-4 text-center w-80 lg:text-left sm:w-3/4 lg:w-full">
