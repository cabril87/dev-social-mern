...
const Navbar = () => {
    ...
    return (
        <>
            <nav className="container flex items-center w-80 lg:w-auto mx-auto sm:mt-4">
                ...
                <ul className="hidden sm:flex flex-1 justify-end items-center gap-5 uppercase text-xs">
                    ...
                    <button type="button" className="bg-color-blue text-white rounded-md px-7 py-3 uppercase">Register</button>
                    <button type="button" className="bg-color-red text-white rounded-md px-7 py-3 uppercase">Login</button>
                </ul>
